...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(RideNotFindException.class)
	...
	@ExceptionHandler(MobileNoIsNotValid.class)
	public ResponseEntity<CustomErrorResponse> MobileNoIsNotValid(Exception ex, WebRequest request) {
