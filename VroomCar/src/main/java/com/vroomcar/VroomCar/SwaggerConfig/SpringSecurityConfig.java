package com.vroomcar.VroomCar.SwaggerConfig;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.antMatchers(HttpMethod.GET, "/Rest/VroomCar/allRides").hasRole("USER")
				.antMatchers(HttpMethod.POST, "/Rest/VroomCar/loadRide").hasRole("ADMIN")
				.antMatchers(HttpMethod.PUT, "/Rest/VroomCar/Rides/{id}").hasRole("ADMIN")
				.antMatchers(HttpMethod.PATCH, "Rest/VroomCar/**").hasRole("ADMIN")
				.antMatchers(HttpMethod.DELETE, "/Rest/VroomCar/Rides/{id}").hasRole("ADMIN").and().csrf().disable().formLogin()
				.disable();
	}
